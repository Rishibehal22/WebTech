        ...
        <form action="#">
          ...
          <div class="newsletter-header">
            ...
            <p class="newsletter-desc">
              Subscribe the <b>Him's and Her's</b> to get latest products and discount update.
            </p>
    ...
    <div class="header-top">
      ...
      <div class="container">
        ...
        <ul class="header-social-container">
          ...
          <li>
            <a href="https://www.instagram.com/hnh.stores/" target="_blank" class="social-link">
        ...
        <div class="header-alert-news">
          <p>
            <b>Free Shipping</b>
            This Week Order Over - &#x20b9;<b>1999</b>.00 
          </p>
        </div>
            ...
            <div class="service-container">
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <p class="service-desc">For Order Over &#x20b9; <b>9999</b>.00</p>
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <p class="service-desc">For Every Order</p>
  ...
  <footer>
      ...
      <div class="container">
        ...
        <ul class="footer-nav-list">
          ...
          <li class="footer-nav-item flex">
            ...
            <a href="#" class="footer-nav-link">+91 9876543210</a>
          </li>
        ...
        <ul class="footer-nav-list">
          ...
          <li>
            <ul class="social-link">
              ...
              <li class="footer-nav-item">
                <a href="https://www.instagram.com/hnh.stores/" class="footer-nav-link">
                  <ion-icon name="logo-instagram"></ion-icon>
                </a>
              </li>
    ...
    <div class="footer-bottom">
      ...
      <div class="container">
        ...
        <p class="copyright">
          Copyright &copy; <a href="#">H&H</a> all rights reserved.
        </p>
